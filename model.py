...
class EvolveGCNO(nn.Module):
    def __init__(self, in_feats=166, n_hidden=256, num_layers=2, n_classes=2, classifier_hidden=307):
        ...
        self.gnn_convs.append(
            GraphConv(in_feats=in_feats, out_feats=n_hidden, bias=False, activation=nn.RReLU(), weight=False))#改动点
        for _ in range(num_layers -1):#改动点，上下应该可以合并啊
        ...
        print("mlp shape :",n_hidden,classifier_hidden)
